...
class CrawlingBoard :
    ...
    def Crawling(self):
        ...
        for i in board_list:
            ...
            challenge.append({"link":Base_URL + link,"title":title,"field":field,"target":target,"organization":organization,"date":date,"price":price,"won_price":won_price,"homepage":homepage})          
